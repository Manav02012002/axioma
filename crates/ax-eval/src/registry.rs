...
pub fn std_modules() -> Vec<StdModule> {
    vec![
        ...
        m("qft/dirac", "Dirac / spinor manipulations: Dirac-bar expansion, spinor sorting, and Fierz rearrangement in four dimensions.", "expand_diracbar, sort_spinors, fierz"),
